...
We imputed missing values based on average number of steps in particular 5-minutes interval. 
...
Mean of the total number of steps taken per day increased while median decreased.
Imputing missing data resulted in increase of total daily number of steps.
